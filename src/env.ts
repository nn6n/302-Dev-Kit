...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_OFFICIAL_WEBSITE_URL_GLOBAL: process.env.NEXT_PUBLIC_OFFICIAL_WEBSITE_URL_GLOBAL,
    NEXT_PUBLIC_OFFICIAL_WEBSITE_URL_CHINA: process.env.NEXT_PUBLIC_OFFICIAL_WEBSITE_URL_CHINA,
