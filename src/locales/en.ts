...
const en: LocaleType = {
  ...
  Error: {
    ...
    TotalOut: (domain: string) => `Total quota for this tool has been used up, more information please visit ${domain}`, // -10006
    TodayOut: (domain: string) => `Daily quota for this tool has been used up, for more information please visit ${domain}`, // -10007
    HourOut: (domain: string) => `This free tool's hour quota reached maximum limit. Please view ${domain} to create your own tool`, // -10012
    GenerateImageError: "Image generation error, please try switching models or modifying the prompt",
  },
  Auth: {
    Title: "Authorization",
  ...
  About: {
    ...
    Loading: "Loading...",
    CreateInfo: (user: string) => `This tool was created by 302.AI user ${user}, 302.AI is a platform for generating and sharing AI tools, you can generate your own AI tools with one click`,
    TotalInfo: (all: number, use: number) => `The total quota for this tool is <${all}PTC>, <${use}PTC> has been used`,
    DayInfo: (all: number, use: number) => `The daily quota for this tool is <${all}PTC>, <${use}PTC> has been used`,
    RecordInfo: "The generation records of this tool are stored locally and will not be uploaded. The user who generated this tool cannot see your generation records",
